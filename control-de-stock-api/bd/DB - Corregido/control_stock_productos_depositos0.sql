...
CREATE TABLE `productos_depositos` (
  ...
  KEY `fk_id_deposito_idx` (`id_deposito`),
  CONSTRAINT `fk_id_deposito` FOREIGN KEY (`id_deposito`) REFERENCES `depositos` (`id`),
...
INSERT INTO `productos_depositos` VALUES (1,30,'2023-10-11 15:32:44',1,2),(2,0,'2023-10-11 15:50:23',1,1);
